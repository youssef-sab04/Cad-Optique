...
const OrdonnanceLentilleDetailModal = ({ open, setOpen, ordonnance }) => {
                    ...
                    <DialogPanel className="relative bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden">
                        ...
                        <div className="bg-slate-900 px-6 py-5">
                            <DialogTitle className="text-base font-bold text-white">
                                Ordonnance lentille de {ordonnance.clientDTO?.nom} {ordonnance.clientDTO?.prenom}
                            </DialogTitle>
                        ...
                        <div className="px-6 py-4">
                            <div className="grid grid-cols-2 gap-x-6">
                                <div>
                                    ...
                                    <InfoRow icon={Eye} label="Rayon" value={ordonnance.rayonOd} />
                                    <InfoRow icon={Eye} label="Diamètre" value={ordonnance.diametreOd} />
                                    <InfoRow icon={Eye} label="Matière" value={ordonnance.matiereOd} />
                                </div>
                                <div>
                                    ...
                                    <InfoRow icon={Eye} label="Rayon" value={ordonnance.rayonOg} />
                                    <InfoRow icon={Eye} label="Diamètre" value={ordonnance.diametreOg} />
                                    <InfoRow icon={Eye} label="Matière" value={ordonnance.matiereOg} />
                                </div>
                            </div>
...
export default OrdonnanceLentilleDetailModal;