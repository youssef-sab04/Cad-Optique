...
import { addCommande } from "../../store/reducers/actions";
const CommandeModal = ({ open, setOpen, fournisseur }) => {
    ...
    const onSubmit = (data) => {
        dispatch(addCommande(fournisseur.id, data, toast, reset, setOpen, setBtnLoader));
    };
