...
import { addDevisItem } from "../../store/reducers/actions";
import { useState } from "react";
import ProductSearchSelect from "../shared/ProductSearchSelect";

const DevisItemModal = ({ open, setOpen, devisId, onSuccess }) => {
    ...
    const unitPrice = selectedProduct?.prixHT ?? 0;
