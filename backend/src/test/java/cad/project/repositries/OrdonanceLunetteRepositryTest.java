...
@Testcontainers
public class OrdonanceLunetteRepositryTest {
    ...
    private OrdonnanceLunette ordonnance;
    ...
    void setup() {
        ...
        ordonnance = new OrdonnanceLunette();
    ...
    @Test
    @DisplayName("findByClientId retourne les ordonnances lunette du client")
    void testFindByClientId() {
        ordonanceLunetteRepositry.save(ordonnance);

        List<OrdonnanceLunette> result = ordonanceLunetteRepositry.findByClientId(client.getId());
    ...
    void testFindByClientId_empty() {
        List<OrdonnanceLunette> result = ordonanceLunetteRepositry.findByClientId(999L);
    ...
    void testFindAll_withSpecification() {
        ...
        Page<OrdonnanceLunette> result = ordonanceLunetteRepositry.findAll(spec, pageable);
    ...
    void testFindByDateExpirationBetween() {
        ...
        List<OrdonnanceLunette> result = ordonanceLunetteRepositry.findByDateExpirationBetween(
